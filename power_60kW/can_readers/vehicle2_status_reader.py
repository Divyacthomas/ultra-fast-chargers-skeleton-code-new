...
class Vehicle2StatusReader(BaseReader):
    ...
    def read_input_data(self):
        ...
        target_power_from_car2 = int(target_volatge_from_car2 * tag_curr22)
        ...
        if vehicle_status2 == 2 and vehicle_status1_g == 0 or vehicle_status2 == 2 and vehicle_status1_g == 6 :
           ...
           # print("ev2=",maxpowerev2_g)

            if maxpowerev2_g > 0 and maxpowerev2_g <= 30000:
                PECC.LIMITS1_DATA_60kw[4] = 184
                PECC.LIMITS1_DATA_60kw[5] = 11
                PECC.LIMITS2_DATA_60kw[2] = 232
                PECC.LIMITS2_DATA_60kw[3] = 3
            else:
                PECC.LIMITS1_DATA_60kw[4] = 112
                PECC.LIMITS1_DATA_60kw[5] = 23
                PECC.LIMITS2_DATA_60kw[2] = 208
                PECC.LIMITS2_DATA_60kw[3] = 7
            digitl_input = self._global_data.get_data()
            if digitl_input[2] == '0' or digitl_input[3] == '1':
        ...
        if vehicle_status2 == 29 and vehicle_status1_g == 0 or vehicle_status2 == 29 and vehicle_status1_g == 6:
            ...
            elif target_power_from_car2 <= 30000:
                PECC.LIMITS1_DATA_60kw[4] = 184
                PECC.LIMITS1_DATA_60kw[5] = 11
                PECC.LIMITS2_DATA_60kw[2] = 232
                PECC.LIMITS2_DATA_60kw[3] = 3
